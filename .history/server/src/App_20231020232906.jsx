...
function App() {
    ...
    async (e) => {
      ...
      try {
        ...
        await axios
          ...
          .then((res) => setAvatar(`http://localhost:4000/${res.data.path}`));
        setImg(null);
      } catch (error) {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-300 via-purple-200 to-pink-400 h-[100vh] flex flex-col gap-[60px] justify-center items-center">
      <div className="overflow-hidden w-[250px] h-[250px] rounded-full bg-slate-500 flex items-center justify-center">
        <img className="object-contain w-full h-full " src={avatar} alt="Account Image" />
      </div>
